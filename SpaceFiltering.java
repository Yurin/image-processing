...
public class SpaceFiltering {
	...
	// };
	// static double filter[] = {//重みなし
	// 	1.0 / 9, 1.0 / 9, 1.0 / 9,
	// 	1.0 / 9, 1.0 / 9, 1.0 / 9,
	// 	1.0 / 9, 1.0 / 9, 1.0 / 9
	// };
	// static double filter[] = {//垂直に重み
	// 	0.1, 0.2, 0.1,
	// 	0.0, 0.2, 0.0,
	// 	0.1, 0.2, 0.1
	// };
	// static double filter[] = {//ソーベル
	// 	-1, 0, 1,
	// 	-2, 0, 2,
	// 	-1, 0, 1
	// };
	// static double filter[] = {//ラプラシアン
	// 	1,  1,  1,
	// 	1, -8,  1,
	// 	1,  1,  1
	// };	
	// static double filter[] = {//シャープ化
	// 	0, -1,  0,
	//    -1,  5, -1,
	// 	0, -1,  0
	// };
	static double filter[] = {//オリジナル
		5, -10,  5,
	   -3,  5, -3,
		0, 2,  0
	};
